...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numSamples; i++) {
            ...
            //Now, we calculate the function for each value:
            y[i] = trueY + (rand.nextDouble() - 0.5) * 0.5;
        }
        //We show the results of traditional gradient descent, which should be far off since it'ss non-linear
        ...
        //Now we pass on to the quantum enhanced optimization.
